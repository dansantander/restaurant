const renderMenu = () => {
  ...
  list2Text1.textContent = 'iceberg lettuce, house-made blue cheese dressing, applewood smoked bacon, croutons';
  ...
  list2Text2.textContent = 'iceberg lettuce, blue cheese, avocado, tomato, crispy applewood smoked bacon, hard-boiled egg wedges, house-made balsamic vinaigrette';
  ...
  list2Text3.textContent = 'kale, golded raisins, shallots, parmesan cheese, lemon dressing, croutons';
  ...
  listRText1.textContent = '12-ounce Certified Angus Beef® ribeye marinated in soy, pineapple, garlic & ginger';
  ...
  listRText2.textContent = '12-ounce Certified Angus Beef®, grilled served with Worcestershire butter';
  ...
  listRText3.textContent = 'Four skewers of beef tenderloin marinated in soy, ginger, garlic &amp; pineapple. Served with BBQ sauce';
  ...
  listRText4.textContent = 'Four skewers of beef tenderloin marinated in soy, ginger, garlic &amp; pineapple. Served with BBQ sauce';
